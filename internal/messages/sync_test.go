...
func TestSync(t *testing.T) {
	...
	validSyncMessageBuf := []byte{
		...
		0x67, 0x00, 0x00, 0x00, 123, 34, 112, 108, 97, 121, 101, 114, 115, 34, 58, 123, 34, 48, 48, 48, 48, 48, 48, 48, 48, 45, 48, 48, 48, 48, 45, 48, 48, 48, 48, 45, 48, 48, 48, 48, 45, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 34, 58, 123, 34, 117, 115, 101, 114, 110, 97, 109, 101, 34, 58, 34, 106, 111, 104, 110, 100, 111, 101, 34, 44, 34, 111, 110, 108, 105, 110, 101, 34, 58, 102, 97, 108, 115, 101, 125, 125, 44, 34, 108, 101, 118, 101, 108, 34, 58, 110, 117, 108, 108, 125,
	}
